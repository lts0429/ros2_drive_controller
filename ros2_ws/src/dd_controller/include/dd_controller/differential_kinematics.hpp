...
namespace differential_kinematics
{
    ...
    void calculate_wheel_speeds(const geometry_msgs::msg::Twist::SharedPtr& twist,
                                double wheel_radius,
                                double wheelbase, 
                                std_msgs::msg::Float64& left_speed, 
                                std_msgs::msg::Float64& right_speed)
    {
        ...
        left_speed.data = (v_linear - (wheelbase / 2.0) * omega_angular) / wheel_radius;
        right_speed.data = (v_linear + (wheelbase / 2.0) * omega_angular) / wheel_radius;
    }
}  // namespace differential_kinematics
